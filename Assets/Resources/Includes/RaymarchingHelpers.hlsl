...
bool TraverseHeightfieldMaxMipChunk(
    ...
    out float hitT,
    out float hitHeight,
    float distanceForHit, Texture2DArray<float> heightmap, float2 chunkSize, float heightScale, SamplerState linearClampSampler, int maxSteps, float3 offset, int slice)
{
    uint4 dimensions;
